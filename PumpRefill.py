...
ttk.Label(mainframe, text='Pump 100uL to clear bubbles,').grid(column=1, row=1, columnspan=2)
ttk.Label(mainframe, text='then fill the indicated volume.').grid(column=1, row=2, columnspan=2)
ttk.Button(mainframe, width=10, text="Draw 500uL", command=draw_500).grid(column=1, row=3)
ttk.Button(mainframe, width=10, text="Draw 1000uL", command=draw_1000).grid(column=2, row=3)
ttk.Button(mainframe, width=10, text="Draw 1500uL", command=draw_1500).grid(column=1, row=4)
ttk.Button(mainframe, width=10, text="Draw 2000uL", command=draw_2000).grid(column=2, row=4)

ttk.Label(mainframe, text='Pump 200uL to clear the line.').grid(column=1, row=6, columnspan=2)
...
ttk.Label(mainframe, text='').grid(column=1, row=12)

customDraw = tk.StringVar()
ttk.Label(mainframe, text='Withdraw/Pump Custom Volume').grid(column=1, row=9, columnspan=2)
ttk.Entry(mainframe, width=10, textvariable=customDraw).grid(column=1, row=10)
ttk.Button(mainframe, width=10, text="Draw", command=draw_custom).grid(column=2, row=10)

customInfuse = tk.StringVar()
ttk.Entry(mainframe, width=10, textvariable=customInfuse).grid(column=1, row=11)
ttk.Button(mainframe, width=10, text="Pump", command=pump_custom).grid(column=2, row=11)

infoLabel = tk.StringVar()
infoLabel.set('Diameter = ' + str(syringe_diameter) + '   |   Rate = 33uL/sec')
